...
namespace CPI.ViewModels
{
    public static class ColorsPalette
    {
        ...
        public static SolidColorBrush Red
        {
            get
            {
                return new BrushConverter().ConvertFromString("#CCE53935") as SolidColorBrush;

            }
        }
        public static SolidColorBrush Green { get { return new BrushConverter().ConvertFromString("#CC43A047") as SolidColorBrush; } }
        public static SolidColorBrush Gray { get { return new BrushConverter().ConvertFromString("#CC888888") as SolidColorBrush; } }
        public static SolidColorBrush Blue { get { return new BrushConverter().ConvertFromString("#CC1E88E5") as SolidColorBrush; } }
        public static SolidColorBrush Orange { get { return new BrushConverter().ConvertFromString("#CCFF9800") as SolidColorBrush; } }
        public static SolidColorBrush Yellow { get { return new BrushConverter().ConvertFromString("#CCFFB74D") as SolidColorBrush; } } 
